...
#define BSCRIPT_VOID_METHOD(class_name,name) \
	void static name(std::vector<TStackValue> &_formal_params, TStackValue& _result, TStackValue& _obj)\
		{\
		class_name* obj=(class_name*)_obj.get();\
		obj->name();\
		}\
	void name()
...
#define BSCRIPT_VOID_METHOD1(class_name,name,type1,arg1) \
	void static name(std::vector<TStackValue> &_formal_params, TStackValue& _result, TStackValue& _obj)\
		{\
		class_name* obj=(class_name*)_obj.get();\
		type1* p1=(type1*)_formal_params[0].get();\
		obj->name(*p1);\
		}\
...
#define BSCRIPT_VOID_METHOD2(class_name,name,type1,arg1,type2,arg2) \
	void static name(std::vector<TStackValue> &_formal_params, TStackValue& _result, TStackValue& _obj)\
		...
		class_name* obj=(class_name*)_obj.get();\
		type1* p1=(type1*)_formal_params[0].get();\
		type2* p2=(type2*)_formal_params[1].get();\
		obj->name(*p1,*p2);\
		}\
...
#define BSCRIPT_VOID_METHOD3(class_name,name,type1,arg1,type2,arg2,type3,arg3) \
	void static name(std::vector<TStackValue> &_formal_params, TStackValue& _result, TStackValue& _obj)\
		...
		type1* p1=(type1*)_formal_params[0].get();\
		type2* p2=(type2*)_formal_params[1].get();\
		type3* p3=(type3*)_formal_params[2].get();\
		obj->name(*p1,*p2, *p3);\
				}\
...
#define BSCRIPT_METHOD1(ret_type,class_name,name,type1,arg1) \
	void static name(std::vector<TStackValue> &_formal_params, TStackValue& _result, TStackValue& _obj)\
		...
		class_name* obj=(class_name*)_obj.get();\
		type1* p1=(type1*)_formal_params[0].get();\
		ret_type* r=(ret_type*)_result.get();\
		*r=obj->name(*p1);\
		}\
