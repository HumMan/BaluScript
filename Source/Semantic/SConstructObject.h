...
public:
	...
	void Build(TSLocalVar* local_var, TTokenPos* source, std::vector<std::unique_ptr<TExpression>>& params, std::vector<TSClassField*>* static_fields, std::vector<TSLocalVar*>* static_variables);
